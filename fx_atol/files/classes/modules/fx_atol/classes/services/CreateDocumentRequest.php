...
class CreateDocumentRequest extends BaseServiceRequest{
    ...
    /**Устанавливает итоговую сумму чека */
    public function addPaymentSum($sum){
        $this->paymentSum = $sum;
        return $this;
    }
    ...
    public function getParameters() {        
        ...
        foreach($this->receiptPositions as $receiptPosition){
            $itemsAmount += $receiptPosition->getPositionSum();
            $items[] = $receiptPosition->getParameters();
        }
        $totalAmount = ($this->paymentSum)?$this->paymentSum:$itemsAmount;
